...
//    design.ReformBlock();//This will combine adjacent blocks
    ...
    */
    ...
    vector<Node> new_buffered_nodes = design.Improve();
    /*for (int i = 0; i < buffered_nodes.size(); i++){
        cout << i << " "<< buffered_nodes[i].point_.x<< " "<<  buffered_nodes[i].point_.y<<  " "<< buffered_nodes[i].parent_<< endl;
    }*/
