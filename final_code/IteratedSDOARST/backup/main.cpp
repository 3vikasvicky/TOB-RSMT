...
void Write_OARSMT(){
	string file_name = "./benchmarks/" + path.substr(18,4) + "_T_NoObstacle" + "/" + path.substr(18,4) + "_T_NoObstacle.branch";
...
void Write_Slack(){
  string delayfilename = "./benchmarks/" + path.substr(18,4) + "_T_NoObstacle/timing.txt";
  string sinkfilename = "./benchOARST_Timing/" + path.substr(18,4) + "_T.net";
  string slackfilename = "./benchmarks/" + path.substr(18,4) + "_T_NoObstacle/slack.txt";
...
int main(int argc, char **argv)
{
    //Right now is: ./a.out RC2_T Table/table.log CapUpperBound.cap > TRUNK_Analysis_Log/execution_RC02.log
    //Original is: ./a.out benchOARST_Timing/RC02_T.net Table/table.log CapUpperBound.cap > TRUNK_Analysis_Log/execution_RC02.log
    cout<<"\nargv[1] = "<<argv[1]<<endl;
	string temp(argv[1]);
	path = temp;
    cout<<"argv[2] = "<<argv[2]<<endl;	

	string delteLog = "rm ./benchmarks/" + path.substr(18,4) + "_T_NoObstacle/slack.txt";
	const char * delteLog_c = delteLog.c_str();
	system(delteLog_c);
  ...
  cout<<"\n-------------Run Buffering-----------\n";
  string command = "./rebranching/roo ./benchmarks/ " + path.substr(18,4) + "_T_NoObstacle " + "3500";
  ...
  for(int i=0; i<5; i++){  
      ...
      cout<<"\n-------------Run Buffering-----------\n";
      command = "./rebranching/roo ./benchmarks/ " + path.substr(18,4) + "_T_NoObstacle " + "3500";
