...
while ($RC_index <= 12)
    ...
    roo . RC${RC_index}_T_NoObstacle 70 >>& result
    if (-e "/home/polaris/yzhang1/rebranching/benchmarks/RC${RC_index}_BOBRSMT_OUTPUT/RC${RC_index}_BOBRSMT_OUTPUT.branch") then
        rm /home/polaris/yzhang1/rebranching/benchmarks/RC${RC_index}_BOBRSMT_OUTPUT/RC${RC_index}_BOBRSMT_OUTPUT.branch
    endif
