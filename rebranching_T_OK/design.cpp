...
void Design::ReadBuffer (vector<Node> & nodes){//from small to big ones
...
void Design::CalculateElmore(vector<Node>& nodes, map<int,double>&slew_map, map<int,double>&delay_map)const{//Calculate Elmore values for all EP and MP. EP and MP may have different size due to eliminating MP
